...
use crate::ffi::llama_cpp::{self, LlamaBatch, LlamaContextParams, LlamaModelParams};
...
impl NativeLlama {
    ...
    pub fn stitch_skill(&self, skill_id: i32, offset: i32, length: i32) -> anyhow::Result<()> {
        info!(
            "🧵 [Native-Llama] Stitching Neural Skill (ID: {}) into KV-Cache at offset: {}",
            skill_id, offset
        );
        ...
        unsafe {
            ...
            info!(
                "✅ [Native-Llama] Skill {} stitched successfully (Length: {} tokens).",
                skill_id, length
            );
        }
    ...
    pub fn stream_tokens(
        ...
        unsafe {
            ...
            llama_cpp::llama_sampler_chain_add(
                sampler_chain,
                llama_cpp::llama_sampler_init_temp(0.7),
            );
            llama_cpp::llama_sampler_chain_add(
                sampler_chain,
                llama_cpp::llama_sampler_init_top_p(0.9, 1),
            );
            llama_cpp::llama_sampler_chain_add(
                sampler_chain,
                llama_cpp::llama_sampler_init_dist(42),
            );
            llama_cpp::llama_sampler_chain_add(
                sampler_chain,
            ...
            while n_gen < max_tokens as i32 {
                ...
                if n_gen % 50 == 0 && n_gen > 0 {
                    ...
                    let thinking_sampler =
                        llama_cpp::llama_sampler_chain_init(std::ptr::null_mut());
                    llama_cpp::llama_sampler_chain_add(
                        thinking_sampler,
                        llama_cpp::llama_sampler_init_temp(0.2),
                    );
                    llama_cpp::llama_sampler_chain_add(
                        thinking_sampler,
                        llama_cpp::llama_sampler_init_greedy(),
                    ...
                    let reasoned_token =
                        llama_cpp::llama_sampler_sample(thinking_sampler, self.ctx_ptr, -1);
