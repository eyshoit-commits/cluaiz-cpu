...
pub fn render_widget(app: &mut AppState, _theme: &Theme, area: Rect, buf: &mut Buffer) {
    ...
    for (cat_key, cat_label, cat_color) in categories {
        ...
        for cmd in group {
            ...
            items.push(ListItem::new(Line::from(vec![
                ...
                Span::styled(cmd.description.clone(), Style::default().fg(Color::Gray)),
            ])));
    ...
    let tip = Line::from(vec![
        ...
        Span::styled("Add commands to ", Style::default().fg(Color::DarkGray)),
        Span::styled("commands.json", Style::default().fg(Color::Yellow)),
        Span::styled(
            " — no recompile needed.",
