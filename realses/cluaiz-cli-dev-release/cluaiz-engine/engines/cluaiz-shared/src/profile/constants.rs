...
pub const ACCOUNT_TYPES: &[OptionItem] = &[
    OptionItem {
        id: "personal",
        label: "Individual / Personal Assistant",
        icon: "👤",
    },
    OptionItem {
        id: "business",
...
pub const INDUSTRY_TAXONOMY: &[IndustryEntry] = &[
    IndustryEntry {
        ...
        sub_categories: &[
            SubCategory {
                id: "d2c",
                label: "Direct-to-Consumer (D2C Brand)",
                icon: "🏷️",
            },
            SubCategory {
                id: "marketplace",
                label: "Amazon/Flipkart Seller",
                icon: "📦",
            },
            SubCategory {
                id: "dropshipping",
    ...
    IndustryEntry {
        ...
        sub_categories: &[
            ...
            SubCategory {
                id: "tutoring",
                label: "Tutoring / Coaching Center",
                icon: "📚",
            },
            SubCategory {
                id: "online_courses",
    ...
    IndustryEntry {
        ...
        sub_categories: &[
            SubCategory {
                id: "content_creator",
                label: "YouTuber / Content Creator",
                icon: "🎥",
            },
            SubCategory {
                id: "community",
