...
pub use backend::{context::*, signature::*, traits::*};
...
impl crate::backend::traits::UnifiedBackend for CluaizLinkerPlaceholder {
    fn generate(
        ...
        Err(
            "✅ SOVEREIGN LINKER: Phase 1 Handshake Success. Real inference pending Phase 2."
                .to_string(),
        )
    }
...
impl crate::backend::traits::CluaizInference for CluaizLinkerPlaceholder {
    ...
    fn generate_stream(
        ...
        Err(anyhow::anyhow!(
            "✅ SOVEREIGN LINKER: Handshake Complete. Ready for Phase 2."
        ))
    }
}
